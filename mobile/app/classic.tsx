...
// The pre-Opportunity-Field home screen, preserved as-is at /classic for
// comparison/fallback (ADR-026) -- this used to be app/index.tsx.
export default function ClassicBriefingScreen() {
